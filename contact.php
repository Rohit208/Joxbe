...
<html lang="en-US" dir="ltr">
  ...
  <body data-spy="scroll" data-target=".onpage-navigation" data-offset="60">
    <main>
      ...
      <section class="home-section home-full-height bg-dark-30" id="home" data-background="assets/images/data-background.jpg">
        <div class="joxbe-caption">
          <div class="caption-content">
            <div class="font-main-title mb-30 joxbe-title-size-3 text-type-animation">The Power of Words at your Service</div>
          </div>
        </div>
      </section>
      ...
      <div class="main">
        <section class="module">
          <div class="container">
            <div class="row">
              <div class="col-sm-6">
                <h4 class="font-alt"><span class=" icon-envelope"></span>  Time to get to know each other  <a href="https://www.facebook.com/Joxbe-1735913369860884/"><i class="fa fa-facebook"></i></a>
                ...
                <form id="contactForm" role="form" method="post" action="php/contact.php">
                  ...
                  <div class="form-group">
                    <textarea class="form-control" rows="7" id="message" name="message" placeholder="Drop a message.." required="required" data-validation-required-message="Please enter your message."></textarea>
                    <p class="help-block text-danger"></p>
                  </div>
              ...
              <div class="col-sm-6">
                <h4 class="font-alt"><span class="icon-briefcase"></span>  Let’s Handshake</h4>
                <p>We adore discussing content marketing. If you have any query or comment, slip your notes in the given box and we will get back to you.</p>
                <p>DOUBLE YOUR TRAFFIC</p>
                <hr/>
        ...
        <section id="map-section">
          ...
          <script>
           function initMap() {
               var myLatLng = {lat: 26.846903, lng: 80.939375};
